{application,hackney,
             [{description,"simple HTTP client"},
              ...
              {env,[{timeout,150000},
                    ...
                    {maxr,10},
                    {maxt,1}]},
              {contributors,["Benoit Chesneau","Adam Rutkowski",
              ...
              {modules,[hackney,hackney_app,hackney_bstr,hackney_cacerts,
                        hackney_connect,hackney_cookie,hackney_date,
                        hackney_deps,hackney_dummy_metrics,
                        hackney_exometer_metrics,hackney_folsom_metrics,
                        hackney_headers,hackney_http,hackney_http_connect,
                        hackney_idna,hackney_manager,hackney_mimetypes,
